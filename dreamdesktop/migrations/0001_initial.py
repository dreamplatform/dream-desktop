...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Gadget'
        db.create_table('dreamdesktop_gadget', (
        ...
        db.send_create_signal('dreamdesktop', ['Gadget'])

        # Adding model 'UserGadget'
        db.create_table('dreamdesktop_usergadget', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gadgets', to=orm['auth.User'])),
            ('gadget', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_gadgets', to=orm['dreamdesktop.Gadget'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('dreamdesktop', ['UserGadget'])

        # Adding model 'Dialog'
        db.create_table('dreamdesktop_dialog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('dreamdesktop', ['Dialog'])


    def backwards(self, orm):
        
        # Deleting model 'Gadget'
        db.delete_table('dreamdesktop_gadget')

        # Deleting model 'UserGadget'
        db.delete_table('dreamdesktop_usergadget')

        # Deleting model 'Dialog'
        db.delete_table('dreamdesktop_dialog')

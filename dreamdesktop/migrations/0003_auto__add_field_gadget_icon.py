...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gadget.icon'
        db.add_column('dreamdesktop_gadget', 'icon', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gadget.icon'
        db.delete_column('dreamdesktop_gadget', 'icon')
